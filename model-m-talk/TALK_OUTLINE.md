...
**Current runtime:** The per-slide timing metadata totals approximately **39:35**, including the seven-minute live-demo block and excluding audience laughter, transitions, or questions. A natural delivery should land around 40–45 minutes.

## Run of show

| Section | Slides | Target | Job in the story |
| --- | ---: | ---: | --- |
| Prologue and discovery | 1–10 | 5:35 | Establish the quest, introduce the Model M, commit to the dangerous design path, discover and resolve velocity sensing, and identify the project’s open-source starting points. |
| Why this matters | 11–16 | 2:55 | Connect embedded constraints to software engineering and turn the project’s approach into a reusable, licensed build recipe. |
| De-risk before CAD | 17–19 | 1:45 | Select viable parts, verify their contracts, and prove the sensing physics. |
| From design to working PCB | 20–31 | 7:05 | Walk through KiCad, assembly planning, review, fabrication, the design-to-reality interruption, measurement, and rework. |
| From board to key event | 32–43 | 6:50 | Explain the embedded build, real-time scan, calibration, filtering, state, queues, and observability. |
| From event to MIDI cable | 44–48 | 2:45 | Separate instructions from audio and trace one NoteOn to DIN MIDI. |
| From key grid to instrument | 49–52 | 2:20 | Explain the Wicki–Hayden relationship and the payoff of movable interval shapes. |
| Prototype, demo, and finale | 53–59 | 10:20 | Confront production reality, prove the instrument live, return to the quest, close, and leave resources on screen. |

---

## 1. Prologue and discovery — slides 1–10

**Section question:** How do you make a computer keyboard expressive enough to become a musical instrument?

**Narrative movement:** A failed quest produces a new challenge. The Model M supplies a memorable physical object, but its single digital click cannot reveal how hard a key was played. Two discoveries—stacked switches and Hall sensing—change the problem from detecting a press to measuring motion, then Hall sensing resolves piano and forte before the talk identifies its open-source starting points.
...
10. **We Do Not Have to Start from Zero**
...
**Handoff:** This is already more than a keyboard conversion. Before going deeper, answer why a software audience should care.

## 2. Why this matters — slides 11–16

**Section question:** What does an enterprise software engineer gain by caring about embedded systems and custom hardware?

**Narrative movement:** The first audience interruption forces the talk to state its thesis. Constraints make systems expressive, while KiCad and open hardware make the project’s approach reusable.

11. **Interruption: Why Should I Care?**
...
12. **The Constraint Is the Expression**
...
13. **Interruption: How Do I Build One?**
   Change the audience character from skeptical to curious. The question now opens the build explanation instead of arriving after it.

14. **Every Keyboard Begins with Three Powers**
   Present the recipe: an idea, a design tool such as KiCad, and a proven reference design. Clarify that “steal” means licensed study and adaptation, not ignoring ownership.

15. **Copy the Homework; Read the License**
...
16. **An Audio Amplifier Design That Can Legally Be Stolen**
...
**Handoff:** With the idea and licensed references established, reduce risk before committing anything to CAD.

## 3. De-risk before CAD — slides 17–19

**Section question:** Which assumptions should be eliminated before drawing and buying a full-size board?

**Narrative movement:** Turn requirements into a short component list, verify each candidate against primary documentation, and prove the riskiest physical behavior with one end-to-end key.

17. **Eliminate 997 Parts**
   Convert the design into catalog filters: voltage, output type, sensitivity, package, stock, assembly support, and quantity price. There is no universally best component, only the best fit for the project’s constraints.
...
**Handoff:** The parts are viable and the sensing physics works. Now turn that evidence into a manufacturable board.

## 4. From design to working PCB — slides 20–31

**Section question:** How does a software-minded builder get from validated components to hardware that can survive first contact with reality?

**Narrative movement:** KiCad turns electrical intent into a physical layout. Assembly planning, outside review, and Gerber inspection happen before the order; measurement and rework happen after it.

20. **The KiCad Roadmap**
   Preview the three representations of one design: schematic for logic, PCB for physical implementation, and Gerbers for manufacturing.

21. **KiCad in 30 Seconds: Schematic**
...
23. **For Tiny Parts, Buy the Assembled Board**
...
25. **Before “Order,” Invite Someone to Disagree**
...
26. **KiCad in 30 Seconds: Gerbers**
...
27. **Interruption: So It Works, Right?**
...
28. **The PCB Arrived; Bring the Toolbelt**
...
29. **A Bad Trace Is Not a Dead Board**
...
30. **Remove the Part, Not the Pads**
...
31. **You Can Add the Component You Forgot**
...
## 5. From board to key event — slides 32–43
...
34. **One-Way Flow, Explicit Responsibilities**
...
35. **One Millisecond, One Hundred Keys**
...
36. **Priorities Are Part of the Instrument**
...
37. **Every Key Needs Its Own Zero**
...
38. **Four Samples Become One Stable Position**
...
40. **MIDI Is Slower Than the Scan Deadline**
...
41. **Tables Separate Copper from Music**
...
42. **Build One Trustworthy Key Before One Hundred**
...
43. **Observability Is a Hardware Feature**
...
## 6. From event to MIDI cable — slides 44–48
...
44. **Interruption: Where Is the Sound?**
...
48. **Follow One Press from Intent to DIN**
...
## 7. From key grid to instrument — slides 49–52
...
49. **One Note Geometry, Two Instruments**
...
51. **Pianist vs. Isomorphic Layout**
...
## 8. Prototype, demo, and finale — slides 53–59
...
53. **Interruption: Can We Sell It?**
...
56. **Quest Objective: Meet Mark Rober**
