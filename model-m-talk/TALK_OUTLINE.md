...
**Current runtime:** The per-slide timing metadata totals approximately **39:15**, including the seven-minute live-demo block and excluding audience laughter, transitions, or questions. A natural delivery should land around 40–45 minutes.

## Run of show

| Section | Slides | Target | Job in the story |
| --- | ---: | ---: | --- |
| Prologue and discovery | 1–8 | 4:15 | Establish the quest, introduce the Model M, discover velocity sensing, and identify the project’s open-source starting points. |
| Why this matters | 9–15 | 3:55 | Connect embedded constraints to software engineering and turn the project’s approach into a reusable, licensed build recipe. |
| De-risk before CAD | 16–18 | 1:45 | Select viable parts, verify their contracts, and prove the sensing physics. |
| From design to working PCB | 19–30 | 7:05 | Walk through KiCad, assembly planning, review, fabrication, the design-to-reality interruption, measurement, and rework. |
...
## 1. Prologue and discovery — slides 1–8

**Section question:** How do you make a computer keyboard expressive enough to become a musical instrument?

**Narrative movement:** A failed quest produces a new challenge. The Model M supplies a memorable physical object, but its single digital click cannot reveal how hard a key was played. Two discoveries—stacked switches and Hall sensing—change the problem from detecting a press to measuring motion.
...
4. **A New Challenger Appears**  
   Reveal the stock IBM Model M like a boss character. Hold the silhouette before showing the keyboard.
...
6. **One Satisfying Click Too Few**  
...
7. **Two Clues Changed the Question**  
...
8. **We Do Not Have to Start from Zero**  
...
## 2. Why this matters — slides 9–15

**Section question:** What does an enterprise software engineer gain by caring about embedded systems and custom hardware?

**Narrative movement:** The first audience interruption forces the talk to state its thesis. Constraints make systems expressive. Hall sensing solves the core musical constraint, while KiCad and open hardware make the larger design approachable.

9. **Interruption: Why Should I Care?**  
...
10. **The Constraint Is the Expression**  
...
11. **Piano / Forte Solved**  
    Explain the central sensing idea. Choose two fixed Hall-sensor positions, measure the elapsed time between them, and map a slow crossing to low velocity and a fast crossing to high velocity.
...
13. **Every Keyboard Begins with Three Powers**  
...
14. **Copy the Homework; Read the License**  
    Explain open hardware as permission to study, modify, make, and share source designs under explicit terms. Verify the exact product, revision, repository, attribution duties, source obligations, and trademarks.
...
## 3. De-risk before CAD — slides 16–18
...
17. **The Datasheet Is the Source Code**  
    Treat the datasheet as the component contract: behavior, electrical boundaries, wiring, package, sensing location, and pin-to-footprint agreement.

18. **Prove One Key Before Buying One PCB**  
...
## 4. From design to working PCB — slides 19–30
...
29. **Remove the Part, Not the Pads**  
    Explain component removal by package and thermal mass. Heat every joint, lift without force, clean and inspect the pads, then align pin one and install the replacement.
...
50. **Pianist vs. Isomorphic Layout**  
    Use the manga reaction to dramatize the learning cost. Piano muscle memory initially rejects the missing black keys and diagonals, then recognizes that every key reuses the same shape.
...
53. **Production Reality**  
    Begin with an orderly grid, then allow the growing list to overwhelm it. Mention representative problems rather than reading all 36: Model M supply, overheating, factory calibration, noisy power, firmware recovery, alternates, traceability, warranty, cash flow, licensing, and liability. A prototype proves possibility, not manufacturability or margin.
